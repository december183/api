...
<html>
 <head>
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 省分管理-添加省分</h1>
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/Province/index">省分列表</a>&nbsp;&gt;&nbsp;<a href="/api/index.php?s=/Admin/Province/add">添加省分</a>&nbsp;&gt;&nbsp;<a href="/api/index.php?s=/Admin/Province/edit/id/<?php echo ($oneProvince["id"]); ?>">修改省分</a></div>
		    <form method="post" action="/api/index.php?s=/Admin/Province/edit/id/<?php echo ($oneProvince["id"]); ?>">
		    <div class="content">
	    		<div class="input">省分名称：<input type="text" name="name" value="<?php echo ($oneProvince["name"]); ?>" /> <em class="red">*</em></div>
		        <div class="submit">
