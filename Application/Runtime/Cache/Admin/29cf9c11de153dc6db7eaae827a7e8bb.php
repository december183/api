...
<html>
 <head>
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 价格区间管理-新增价格区间</h1>
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/Price/index">价格区间列表</a> &gt; <a href="/api/index.php?s=/Admin/Price/add">新增价格区间</a></div>
