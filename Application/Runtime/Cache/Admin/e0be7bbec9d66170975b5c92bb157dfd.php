...
<html>
 <head>
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 积分商品管理-积分商品列表</h1>
        <div class="bloc">
				...
				<table>
		            ...
		            <tbody>
		            	<?php if(is_array($goodslist)): $i = 0; $__LIST__ = $goodslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		                    ...
		                    <td><?php echo (mb_substr($vo["descript"],0,60,'utf-8')); ?>...</td>
		                    <td><?php echo ($vo["exchangednum"]); ?></td>
		                    ...
		                    <td style="text-align:center;"><a href="/api/index.php?s=/Admin/CreditGoods/edit/id/<?php echo ($vo["id"]); ?>" title="Edit this content"><img src="/api/Public/Admin/img/icons/actions/edit.png" alt="修改" /></a>　<a href="/api/index.php?s=/Admin/CreditGoods/del/cid/<?php echo ($cid); ?>/id/<?php echo ($vo["id"]); ?>" title="Delete this content" onclick="return confirm('你确定要删除这件商品吗？');"><img src="/api/Public/Admin/img/icons/actions/delete.png" alt="删除" /></a></td>
	...
	<script type="text/javascript">
		function isRec(id,target){
			var $target=$(target);
			$.ajax({
				url:'/api/index.php?s=/Admin/CreditGoods/isRec',
				data:{"id":id},
				type:'post',
				dataType:'json',
