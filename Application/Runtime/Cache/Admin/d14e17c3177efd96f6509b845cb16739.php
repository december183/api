...
<html>
 <head>
	...
	<div id="content" class="white">
        ...
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/Province/index">省分列表</a>&nbsp;&gt;&nbsp;<a href="/api/index.php?s=/Admin/Province/add">添加省分</a></div>
		    <form method="post" action="">
		    <div class="content">
	    		<div class="input">省分名称：<input type="text" name="name" /> <em class="red">*</em></div>
		        <div class="submit">
