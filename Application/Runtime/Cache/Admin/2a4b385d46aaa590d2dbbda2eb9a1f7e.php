...
<html>
 <head>
    ...
    <div class="left">
        ...
        |
        <a href="/api/index.php?s=/Admin/Province/logout">退出</a>
    </div>
</div>                
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 省份管理-省份列表</h1>
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/Province/index">省份列表</a> &gt; <a href="/api/index.php?s=/Admin/Province/add">添加省份</a></div>
		    <div class="content">
		   	<form method="post" action="">
				<table>
		            ...
		            <tbody>
		            	<?php if(is_array($provincelist)): $i = 0; $__LIST__ = $provincelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		                    <td><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" /></td>
		                    <td><?php echo ($vo["name"]); ?></td>
		                    <td><input type="text" name="sort[<?php echo ($vo["id"]); ?>]" class="small" value="<?php echo ($vo["sort"]); ?>" /></td>
		                    <td class="actions"><a href="/api/index.php?s=/Admin/Province/edit/id/<?php echo ($vo["id"]); ?>" title="Edit this content"><img src="/api/Public/Admin/img/icons/actions/edit.png" alt="修改" /></a>　<a href="/api/index.php?s=/Admin/Province/del/id/<?php echo ($vo["id"]); ?>" title="Delete this content" onclick="return confirm('你确定要删除这条记录吗？');"><img src="/api/Public/Admin/img/icons/actions/delete.png" alt="删除" /></a></td>
