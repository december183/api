...
<html>
 <head>
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 价格区间管理-价格区间列表</h1>
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/Price/index/gid/1">商品价格区间列表</a> &gt; <a href="/api/index.php?s=/Admin/Price/index/gid/2">服务价格区间列表</a> &gt; <a href="/api/index.php?s=/Admin/Price/add">添加价格区间</a></div>
		    <div class="content">
		   	<form method="post" action="">
				<table>
		            ...
		            <tbody>
		            	<?php if(is_array($pricelist)): $i = 0; $__LIST__ = $pricelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		                    <td><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" /></td>
		                    <td><?php echo ($vo["minprice"]); ?> - <?php echo ($vo["maxprice"]); ?></td>
		                    <td><?php echo ($vo["catename"]); ?></td>
		                    <td class="actions"><a href="/api/index.php?s=/Admin/Price/edit/id/<?php echo ($vo["id"]); ?>" title="Edit this content"><img src="/api/Public/Admin/img/icons/actions/edit.png" alt="修改" /></a>　<a href="/api/index.php?s=/Admin/Price/del/id/<?php echo ($vo["id"]); ?>" title="Delete this content" onclick="return confirm('你确定要删除这个属性吗？');"><img src="/api/Public/Admin/img/icons/actions/delete.png" alt="删除" /></a></td>
