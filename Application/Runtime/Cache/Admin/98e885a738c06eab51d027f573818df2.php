...
<html>
 <head>
	...
	<div id="content" class="white">
        <h1><img src="/api/Public/Admin/img/icons/posts.png" alt="" /> 城市管理-修改城市</h1>
        <div class="bloc">
		    <div class="title"><a href="/api/index.php?s=/Admin/City/index">城市列表</a>&nbsp;&gt;&nbsp;<a href="/api/index.php?s=/Admin/City/add">添加城市</a>&nbsp;&gt;&nbsp;<a href="/api/index.php?s=/Admin/City/edit/id/<?php echo ($oneCity["id"]); ?>">修改城市</a></div>
		    <form method="post" action="">
		    <div class="content">
	    		<div class="input">城市名称：<input type="text" name="name" value="<?php echo ($oneCity["name"]); ?>" /> <em class="red">*</em></div>
	    		<div class="input">
		            所在省分：
		            <select name="pid" id="pid">
		            <option value="0">--请选择所在省分--</option>
	                <?php if(is_array($provincelist)): $i = 0; $__LIST__ = $provincelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($oneCity['pid'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
